class TrainChat:
    ...
    "Oi",
    " Olá, bem vindo ao atendimento do SmartParking. Qual seria sua dúvida? \ 1- Como alterar preço do estacionamento?\ 2- Como alterar o horário de funcionamento?\ 3- Como alterar dados do meu perfil? 4- Como ver o status do meu estacionamento?",
    "Olá",
    " Olá, bem vindo ao atendimento do SmartParking. Qual seria sua dúvida? \ 1- Como alterar preço do estacionamento?\ 2- Como alterar o horário de funcionamento?\ 3- Como alterar dados do meu perfil? 4- Como ver o status do meu estacionamento?",
    "Olá, tudo bem?",
    " Olá, bem vindo ao atendimento do SmartParking. Qual seria sua dúvida? \ 1- Como alterar preço do estacionamento?\ 2- Como alterar o horário de funcionamento?\ 3- Como alterar dados do meu perfil?\ 4- Como ver o status do meu estacionamento?",
